...
for i in range(6):
    ...
    plt.fill_between(range(5), load_con_data, gen_cov_data,
                     ...
                     color='brown',
                     alpha=0.5)
    plt.fill_between(range(5), load_cov_data, np.zeros(5),
                     label='Load\ncovariance',
                     color='orange',
                     alpha=0.5)
    # y/x-axis and title
...
plt.suptitle("Contribution as a Function of Transmission Link Sizes",fontsize=20,x=.51,y=0.92) #,x=.51,y=1.07 
